...
vec::vec4 operator * (const Matrix& lhs, const vec::vec4& rhs) {
    vec::vec4 r;
    r.x = (lhs.m[0][0] * rhs.x) + (lhs.m[0][1] * rhs.y) + (lhs.m[0][2] * rhs.z) + (lhs.m[0][3] * rhs.w);
    r.y = (lhs.m[1][0] * rhs.x) + (lhs.m[1][1] * rhs.y) + (lhs.m[1][2] * rhs.z) + (lhs.m[1][3] * rhs.w);
    r.z = (lhs.m[2][0] * rhs.x) + (lhs.m[2][1] * rhs.y) + (lhs.m[2][2] * rhs.z) + (lhs.m[2][3] * rhs.w);
    r.w = (lhs.m[3][0] * rhs.x) + (lhs.m[3][1] * rhs.y) + (lhs.m[3][2] * rhs.z) + (lhs.m[3][3] * rhs.w);
    return r;
}
